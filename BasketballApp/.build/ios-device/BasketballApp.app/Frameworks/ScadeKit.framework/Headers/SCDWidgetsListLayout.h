...
/*PROTECTED REGION ID(scade::ui::widgets::widgetlayouts::SCDWidgetsListLayout_pre) START*/
...
/*PROTECTED REGION ID(scade::ui::widgets::widgetlayouts::SCDWidgetsListLayout) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
/*PROTECTED REGION END*/
