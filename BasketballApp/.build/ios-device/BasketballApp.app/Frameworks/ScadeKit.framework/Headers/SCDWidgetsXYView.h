...
/*PROTECTED REGION ID(scade::ui::widgets::SCDWidgetsXYView_pre) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
/*PROTECTED REGION END*/


@interface SCDWidgetsXYView : SCDWidgetsContainer         
...
/*PROTECTED REGION ID(scade::ui::widgets::SCDWidgetsXYView) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
/*PROTECTED REGION END*/
