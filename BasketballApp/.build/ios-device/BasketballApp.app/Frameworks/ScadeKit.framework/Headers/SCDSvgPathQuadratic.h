...
/*PROTECTED REGION ID(scade::svg::draw::attributes::path::SCDSvgPathQuadratic_pre) START*/
...
/*PROTECTED REGION ID(scade::svg::draw::attributes::path::SCDSvgPathQuadratic) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
/*PROTECTED REGION END*/
