...
/*PROTECTED REGION ID(scade::ui::widgets::events::SCDWidgetsEditFinishEvent_pre) START*/
...
/*PROTECTED REGION ID(scade::ui::widgets::events::SCDWidgetsEditFinishEvent) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
/*PROTECTED REGION END*/
